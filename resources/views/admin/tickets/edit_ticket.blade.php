...
@section('title','Chỉnh sửa thông tin vé')
@section('content')
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>Mã vé</label>
                        <input type="text" value="{{$ticket->ticket_id}}" name="ticket_id" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Loại vé</label>
                        <input type="text" value="{{$ticket->ticket_type}}" name="ticket_type" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Hạng ghế</label>
                        <input type="text" value="{{$ticket->seat_class}}" name="seat_class" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Giá vé</label>
                        <input type="text" value="{{$ticket->price}}" name="price" class="form-control">
                    </div>
                    <div class="form-group">
